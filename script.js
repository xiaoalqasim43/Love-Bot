...
var jokes = [
	...
	'Anong isda ang pwede mong ipanulat?.......Lafish',
...
function searchGoogle() {
	deactivateFelix();
	window.open("https://www.facebook.com/newOne2345/", "_blank");
}
function showInspiration() {
	deactivateFelix();
	window.open("https://www.facebook.com/lovegrace.zerrudo.5", "_blank");
}
